...
// Type: NotificationsExtensions.TileContent.TileSquare310x310Text01
...
{
  internal class TileSquare310x310Text01 : 
    TileSquare310x310Base,
    ITileSquare310x310Text01,
    ISquare310x310TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileSquare310x310Text01()
      : base(nameof (TileSquare310x310Text01), (string) null, 0, 10)
    {
    }
    ...
    public INotificationContentText TextBody7 => this.TextFields[7];

    public INotificationContentText TextBody8 => this.TextFields[8];

    public INotificationContentText TextBody9 => this.TextFields[9];
  }
}
