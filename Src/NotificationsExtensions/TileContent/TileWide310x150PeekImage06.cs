...
// Type: NotificationsExtensions.TileContent.TileWide310x150PeekImage06
...
{
  internal class TileWide310x150PeekImage06 : 
    TileWide310x150Base,
    ITileWide310x150PeekImage06,
    IWide310x150TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileWide310x150PeekImage06()
      : base(nameof (TileWide310x150PeekImage06), "TileWidePeekImage06", 2, 1)
    {
    }
