...
// Type: NotificationsExtensions.TileContent.TileSquare310x310ImageCollection
...
{
  internal class TileSquare310x310ImageCollection : 
    TileSquare310x310Base,
    ITileSquare310x310ImageCollection,
    ISquare310x310TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileSquare310x310ImageCollection()
      : base(nameof (TileSquare310x310ImageCollection), (string) null, 5, 0)
    {
    }
