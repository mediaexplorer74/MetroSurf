...
// Type: NotificationsExtensions.TileContent.TileWide310x150SmallImageAndText04
...
{
  internal class TileWide310x150SmallImageAndText04 : 
    TileWide310x150Base,
    ITileWide310x150SmallImageAndText04,
    IWide310x150TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileWide310x150SmallImageAndText04()
      : base(nameof (TileWide310x150SmallImageAndText04), "TileWideSmallImageAndText04", 1, 2)
    {
    }
