...
// Type: NotificationsExtensions.TileContent.TileSquare310x310TextList02
...
{
  internal class TileSquare310x310TextList02 : 
    TileSquare310x310Base,
    ITileSquare310x310TextList02,
    ISquare310x310TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileSquare310x310TextList02()
      : base(nameof (TileSquare310x310TextList02), (string) null, 0, 3)
    {
    }
