...
// Type: NotificationsExtensions.TileContent.TileWide310x150SmallImageAndText05
...
{
  internal class TileWide310x150SmallImageAndText05 : 
    TileWide310x150Base,
    ITileWide310x150SmallImageAndText05,
    IWide310x150TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileWide310x150SmallImageAndText05()
      : base(nameof (TileWide310x150SmallImageAndText05), "TileWideSmallImageAndText05", 1, 2)
    {
    }
