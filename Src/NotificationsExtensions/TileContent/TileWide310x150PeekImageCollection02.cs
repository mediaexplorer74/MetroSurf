...
// Type: NotificationsExtensions.TileContent.TileWide310x150PeekImageCollection02
...
{
  internal class TileWide310x150PeekImageCollection02 : 
    TileWide310x150Base,
    ITileWide310x150PeekImageCollection02,
    ...
    INotificationContent
  {
    public TileWide310x150PeekImageCollection02()
      : base(nameof (TileWide310x150PeekImageCollection02), "TileWidePeekImageCollection02", 5, 5)
    {
    }
