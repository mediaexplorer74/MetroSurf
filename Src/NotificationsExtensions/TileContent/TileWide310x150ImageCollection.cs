...
// Type: NotificationsExtensions.TileContent.TileWide310x150ImageCollection
...
{
  internal class TileWide310x150ImageCollection : 
    TileWide310x150Base,
    ...
    INotificationContent
  {
    public TileWide310x150ImageCollection()
      : base(nameof (TileWide310x150ImageCollection), "TileWideImageCollection", 5, 0)
    {
    }
