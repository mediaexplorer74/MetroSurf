...
// Type: NotificationsExtensions.TileContent.TileSquare310x310ImageAndText02
...
{
  internal class TileSquare310x310ImageAndText02 : 
    TileSquare310x310Base,
    ITileSquare310x310ImageAndText02,
    ISquare310x310TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileSquare310x310ImageAndText02()
      : base(nameof (TileSquare310x310ImageAndText02), (string) null, 1, 2)
    {
    }
