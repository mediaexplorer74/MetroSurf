...
// Type: NotificationsExtensions.TileContent.TileWide310x150PeekImageAndText02
...
{
  internal class TileWide310x150PeekImageAndText02 : 
    TileWide310x150Base,
    ITileWide310x150PeekImageAndText02,
    IWide310x150TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileWide310x150PeekImageAndText02()
      : base(nameof (TileWide310x150PeekImageAndText02), "TileWidePeekImageAndText02", 1, 5)
    {
    }
