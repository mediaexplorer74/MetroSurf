...
// Type: NotificationsExtensions.TileContent.TileSquare150x150Text01
...
{
  internal class TileSquare150x150Text01 : 
    TileSquare150x150Base,
    ITileSquare150x150Text01,
    ISquare150x150TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileSquare150x150Text01()
      : base(nameof (TileSquare150x150Text01), "TileSquareText01", 0, 4)
    {
    }
