...
// Type: NotificationsExtensions.TileContent.TileWide310x150SmallImageAndText02
...
{
  internal class TileWide310x150SmallImageAndText02 : 
    TileWide310x150Base,
    ITileWide310x150SmallImageAndText02,
    IWide310x150TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileWide310x150SmallImageAndText02()
      : base(nameof (TileWide310x150SmallImageAndText02), "TileWideSmallImageAndText02", 1, 5)
    {
    }
