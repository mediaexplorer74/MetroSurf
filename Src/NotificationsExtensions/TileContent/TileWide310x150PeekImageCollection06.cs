...
// Type: NotificationsExtensions.TileContent.TileWide310x150PeekImageCollection06
...
{
  internal class TileWide310x150PeekImageCollection06 : 
    TileWide310x150Base,
    ITileWide310x150PeekImageCollection06,
    ...
    INotificationContent
  {
    public TileWide310x150PeekImageCollection06()
      : base(nameof (TileWide310x150PeekImageCollection06), "TileWidePeekImageCollection06", 6, 1)
    {
    }
    ...
    public INotificationContentImage ImageSecondary => this.Images[5];
