...
// Type: NotificationsExtensions.TileContent.TileWide310x150PeekImage02
...
{
  internal class TileWide310x150PeekImage02 : 
    TileWide310x150Base,
    ITileWide310x150PeekImage02,
    IWide310x150TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileWide310x150PeekImage02()
      : base(nameof (TileWide310x150PeekImage02), "TileWidePeekImage02", 1, 5)
    {
    }
