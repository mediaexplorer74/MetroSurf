...
// Type: NotificationsExtensions.TileContent.TileSquare310x310TextList01
...
{
  internal class TileSquare310x310TextList01 : 
    TileSquare310x310Base,
    ITileSquare310x310TextList01,
    ISquare310x310TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileSquare310x310TextList01()
      : base(nameof (TileSquare310x310TextList01), (string) null, 0, 9)
    {
    }
