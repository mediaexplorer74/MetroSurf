...
// Type: NotificationsExtensions.TileContent.TileWide310x150PeekImage01
...
{
  internal class TileWide310x150PeekImage01 : 
    TileWide310x150Base,
    ITileWide310x150PeekImage01,
    IWide310x150TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileWide310x150PeekImage01()
      : base(nameof (TileWide310x150PeekImage01), "TileWidePeekImage01", 1, 2)
    {
    }
