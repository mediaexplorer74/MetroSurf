...
// Type: NotificationsExtensions.TileContent.TileWide310x150PeekImageCollection05
...
{
  internal class TileWide310x150PeekImageCollection05 : 
    TileWide310x150Base,
    ITileWide310x150PeekImageCollection05,
    ...
    INotificationContent
  {
    public TileWide310x150PeekImageCollection05()
      : base(nameof (TileWide310x150PeekImageCollection05), "TileWidePeekImageCollection05", 6, 2)
    {
    }
