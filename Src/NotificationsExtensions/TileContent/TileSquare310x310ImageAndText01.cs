...
// Type: NotificationsExtensions.TileContent.TileSquare310x310ImageAndText01
...
{
  internal class TileSquare310x310ImageAndText01 : 
    TileSquare310x310Base,
    ITileSquare310x310ImageAndText01,
    ISquare310x310TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileSquare310x310ImageAndText01()
      : base(nameof (TileSquare310x310ImageAndText01), (string) null, 1, 1)
    {
    }
