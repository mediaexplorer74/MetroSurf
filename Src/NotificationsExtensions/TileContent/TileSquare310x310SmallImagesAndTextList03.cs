...
// Type: NotificationsExtensions.TileContent.TileSquare310x310SmallImagesAndTextList03
...
{
  internal class TileSquare310x310SmallImagesAndTextList03 : 
    TileSquare310x310Base,
    ITileSquare310x310SmallImagesAndTextList03,
    ISquare310x310TileNotificationContent,
    ITileNotificationContent,
    INotificationContent
  {
    public TileSquare310x310SmallImagesAndTextList03()
      : base(nameof (TileSquare310x310SmallImagesAndTextList03), (string) null, 3, 6)
    {
    }
