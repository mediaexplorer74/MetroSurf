...
// Type: VPN.View.ChangePasswordPage
...
namespace VPN.View
{
  public sealed class ChangePasswordPage : BasePage, IComponentConnector
  {
    ...
    public ChangePasswordPage() => this.InitializeComponent();

    private void OldPasswordBoxOnKeyUp(object sender, KeyRoutedEventArgs e)
    {
      if (e.Key != 13)
        return;
      ((Control) this.NewPasswordBox).Focus((FocusState) 2);
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("ms-appx:///View/ChangePasswordPage.xaml"), (ComponentResourceLocation) 0);
      ...
      this.OldPasswordBox = (PasswordBox) ((FrameworkElement) this).FindName("OldPasswordBox");
      this.NewPasswordBox = (PasswordBox) ((FrameworkElement) this).FindName("NewPasswordBox");
    }
    ...
    public void Connect(int connectionId, object target)
    {
      switch (connectionId)
      {
        ...
        case 2:
          ...
          WindowsRuntimeMarshal.AddEventHandler<KeyEventHandler>(new Func<KeyEventHandler, EventRegistrationToken>(uiElement1.add_KeyUp), new Action<EventRegistrationToken>(uiElement1.remove_KeyUp), new KeyEventHandler(this.OldPasswordBoxOnKeyUp));
          break;
        case 3:
          UIElement uiElement2 = (UIElement) target;
          WindowsRuntimeMarshal.AddEventHandler<KeyEventHandler>(new Func<KeyEventHandler, EventRegistrationToken>(uiElement2.add_KeyUp), new Action<EventRegistrationToken>(uiElement2.remove_KeyUp), new KeyEventHandler(this.NewPasswordBoxOnKeyUp));
          break;
      }
      this._contentLoaded = true;
    }
