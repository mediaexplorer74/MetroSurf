...
// Type: VPN.Converters.BoolToRedColorConverter
...
namespace VPN.Converters
{
  public class BoolToRedColorConverter : IValueConverter
  {
    ...
    {
      return !(bool) value ? (object) new SolidColorBrush(Colors.Black) : (object) new SolidColorBrush(Constants.StatusOffColor);
    }
